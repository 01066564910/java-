...
public class Ex10 {
	...
	public static void main(String[] args) {
		...
		i[1]=i1;
		i[2]=i2;
		// System.out.println(i[1][3]);  //인덱스의 번호가 2가 
		//                                 최대라서 3을 하면 에러가 뜬다.
		...
		iii[2][0]=9;	iii[0][1]=10;	iii[2][2]=11;	iii[2][3]=12;
	...
	//// iiii의 배열의 값의 요소번호와 같이 출력하시오. iiii[0][1]=2
		for(int j =0 ; j<iiii.length; j++) { //밖에다가는 2차항 배열의 크기
			for(int k= 0;  k<iiii[j].length;  k++){ // 안에다가는 1차항 배열의 크기
				//를 적어주면 우리가 원하는 값을 가져올 수 있다.?
